...
export function AccessCodeToast({codes, onClose}: AccessCodeToastProps) {
    return (
        <div style={{ gap: 8, display: 'grid' }}>
            ...
            <label>Você deve copiar estes valores, pois não serão exibidos novamente.</label>
            <ul>
            ...
            <button 
                className="w-full py-3 font-semibold rounded-lg outline-none border-none flex justify-center text-ct-blue-600" 
                onClick={onClose}>
                Fechar
            </button>
        </div>
